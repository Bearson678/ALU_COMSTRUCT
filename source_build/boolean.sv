...
module boolean #(
    ...
    genvar idx_0_614565283;
    
    generate
        for (idx_0_614565283 = 0; idx_0_614565283 < 32; idx_0_614565283 = idx_0_614565283 + 1) begin: forLoop_idx_0_614565283
            mux_4 mux_4_32 (
                .s0(M_mux_4_32_s0[idx_0_614565283]),
                .s1(M_mux_4_32_s1[idx_0_614565283]),
                .in(M_mux_4_32_in[idx_0_614565283]),
                .out(M_mux_4_32_out[idx_0_614565283])
            );
        end
    endgenerate
